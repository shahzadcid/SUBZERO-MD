...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO~24c5913ee3a70dd101b6f86b923d7bedf37f6094",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923135246937",  // Owner's WhatsApp number
    ...
    BOT_IMAGE: getConfig("BOT_IMAGE") || "https://files.catbox.moe/0bszdm.jpg",  // Bot's "alive" image
